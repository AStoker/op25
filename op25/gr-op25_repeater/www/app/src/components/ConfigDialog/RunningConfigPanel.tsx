 ...
 *
 * Lives in the Config dialog rather than in a dashboard card: it answers a
 * question you ask once while setting a system up, not something to scan.
 */
export default function RunningConfigPanel() {
