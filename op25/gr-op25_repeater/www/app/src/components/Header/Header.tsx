    ...
    <Box sx={{ display: 'flex' }}>
      <AppBar component="nav" position="fixed">
        <Toolbar>
          ...
          {/* Theme toggle. The rest of the display preferences — accent colour,
              smart colours — are in Config → Interface; a gear holding one
              switch next to a Config menu was two homes for one thing. */}
          <IconButton
            color="inherit"
            onClick={toggleTheme}
