...
#
sudo pacman -S --needed --noconfirm gnuradio gnuradio-osmosdr rtl-sdr libuhd cmake cppunit doxygen boost orc base-devel clang pkgconf python-thrift pybind11 python-numpy python-waitress python-setuptools python-websockets gnuplot libsndfile spdlog hackrf
