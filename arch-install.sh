...
#
sudo pacman -S --needed --noconfirm gnuradio gnuradio-osmosdr rtl-sdr libuhd cmake cppunit doxygen boost orc base-devel clang pkgconf python-thrift pybind11 python-numpy python-setuptools python-fastapi python-uvicorn libsndfile spdlog hackrf
